...
export default function Header(props) {
  ...
  return(
    <header className="px-4 bg-white shadow-md text-dark-blue md:px-14 dark:bg-element-dark dark:text-gray-100">
      <Container styles="flex items-center justify-between h-20 max-w-screen-4xl mx-auto">
        <Link to="/">
